...
const UserReviewInput = ({ rating, setRating, userReview, setUserReview, setNewReview }) => {
  return (
    <View style={styles.userReview}>
        ...
        <View style={styles.inputSection}>
            <TextInput
                ...
                editable
            />
            <TouchableOpacity onPress={setNewReview} style={[styles.send, { flexDirection: 'row', justifyContent: 'flex-end'}]}>
