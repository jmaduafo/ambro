    ...
    <View style={[generalStyles.default, { position: 'relative'}]}>
      ...
      <SafeAreaView >
        <ScrollView style={[styles.view, { paddingBottom: 80}]}>
          <AccessCamera imagesArray={imagesArray} setImagesArray={setImagesArray}/>
          ...
          <View>
            ...
            <TagsInput setTag={setTag} tag={tag} setTagsArray={setTagsArray} tagsArray={tagsArray}/>
            {/* LINE BREAK */}
            <View style={[generalStyles.lineBreak, { marginTop: 10, marginBottom: 10}]}></View>
  ...
  return (
    <View style={{ marginBottom: 10}}>
      ...
      <View style={{ marginTop: 20}}>
        ...
        <View>
          <TouchableOpacity onPress={handleIngredient} style={[generalStyles.button, generalStyles.rowCenter, {justifyContent: 'center', gap: 10, borderRadius: 5, marginTop: 20}]}>
  ...
  return (
    <View style={{ marginBottom: 10}}>
      ...
      <View style={{ marginTop: 20}}>
        ...
        <View>
          <TouchableOpacity onPress={handleInstructions} style={[generalStyles.button, generalStyles.rowCenter, {justifyContent: 'center', gap: 10, borderRadius: 5, marginTop: 20}]}>
              <PlusCircleIcon color={COLORS.backgroundFull}/>
...
function TagsInput({ setTag, tag, setTagsArray, tagsArray}) {
  ...
  return (
    <View>
      {/* TAGS LIST */}
      <View style={[generalStyles.rowCenter, { flexWrap: 'wrap', gap: 15, marginBottom: 15}]}>
        {tagsArray && 
      ...
      <View style={generalStyles.loginSignupInputSection}>
        ...
        <TextInput
          ...
          placeholderTextColor={COLORS.textColor50}
        />
        <TouchableOpacity onPress={handleTags}  style={[generalStyles.button, generalStyles.rowCenter, {justifyContent: 'center', gap: 10, borderRadius: 5, marginTop: 20}]}>
          <PlusCircleIcon color={COLORS.backgroundFull}/>
